...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("pt"), "", "Selecionar Produto na Loja PO", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        public void SelecaoDeProdutoComSucessoPO(string ususario, string senha, string tituloSecao, string produto, string quantidade, string preco, string[] exampleTags)
        {
            ...
            argumentsOfScenario.Add("ususario", ususario);
...
#line hidden
#line 7
    testRunner.When("preencho o usuário como <usuario> PO", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Quando ");
#line hidden
#line 8
